...
//		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
    ...
    public void connDB() { // 连接数据库
        ...
        try {//创建连接
            con = DriverManager.getConnection(DbConstant.DBURL, DbConstant.USER, DbConstant.PWD);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (source == buttonOfZhuce) {
            if (field1.getText().equals("") || field2.getText().equals("") || field3.getText().equals("")) {// 判断是否输入了用户名和密码
