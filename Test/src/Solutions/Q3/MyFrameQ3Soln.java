...
class MyFrameQ3Soln extends JFrame implements ActionListener{
	...
	private JButton b4=new JButton("All > Target");private JTextField t4=new JTextField("0",15);
	...
	public MyFrameQ3Soln(String s){
		...
		p1.add(b4); p1.add(t4);
		content.add(p1);
		b1.addActionListener(this);  b2.addActionListener(this);   b4.addActionListener(this);  
		setSize(390,300);    setVisible(true);}
